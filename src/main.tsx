    ...
    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
      <div className="lg:pr-8 lg:pt-4">
        <div className="lg:max-w-lg">
          <h2 className="text-base font-semibold leading-7 text-green-600">Microsoft Tenancy Information</h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Azure Domain Enumeration</p>
          <p className="mt-6 text-lg leading-8 text-gray-600">Did you know that the list of domains associated with an Office 365 tenancy can be enumerated with a public SOAP query?</p>
          <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
            <div className="relative pl-9">
              ...
              <dd className="inline"> Research Open Source Intelligence on a target.</dd>
            </div>
            <div className="relative pl-9">
              <dt className="inline font-semibold text-gray-900">
                ...
                Find Business Associations.
              </dt>
              <dd className="inline"> Identify companies posting as distinct entities, operating on a shared account.</dd>
            </div>
            <div className="relative pl-9">
              <dt className="inline font-semibold text-gray-900">
